...
class CustomRobertaModel(RobertaModel):
    def __init__(self, config, vocab_sz, hidden_sz):
        super().__init__(config)
        self.embeddings_v2 = CustomRobertaEmbeddings(config, vocab_sz, hidden_sz)
...
class CustomRobertaForMaskedLM(RobertaForMaskedLM):
    def __init__(self, config, vocab_sz, hidden_sz):
        super().__init__(config)
        self.roberta_v2 = CustomRobertaModel(config, vocab_sz, hidden_sz)
    
    def update_weights(self):
        self.roberta_v2.load_state_dict(self.roberta.state_dict(), strict=False)
